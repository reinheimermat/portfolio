const FedoraIcon = () => (
  ...
  >
    ...
    <path
      ...
      stroke="#3c6eb4"
      strokeWidth="29.21"
      d="M77.126 142.098h47.845v47.844c0 26.41-21.434 47.845-47.845 47.845s-47.844-21.434-47.844-47.845 21.434-47.844 47.844-47.844z"
    />
    <use xlinkHref="#in" id="finity" transform="rotate(180 124.856 142.144)" />
    <path
      id="free"
      fill="#fff"
    ...
    />
    <use xlinkHref="#free" id="dom" transform="rotate(180 124.856 142.144)" />
    <path
      id="TM"
      fill="#3c6eb4"
      d="M243.655 243.584v-5.531l-2.529 5.798-2.461-5.798v5.531h-1.418v-8.735h1.487l2.434 5.58 2.397-5.58h1.505v8.735zm-10.333-7.272v7.272h-1.483v-7.272h-2.484v-1.463h6.449v1.463"
    />
  </svg>
);
